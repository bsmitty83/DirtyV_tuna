...
struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
    ...
    VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPTURBO_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPTURBO, 0, 0, 0xfa, 0x23, OMAP_ABB_FAST_OPP),
...
#define OMAP4460_VDD_MPU_OPP75_UV    		1100000
...
#define OMAP4460_VDD_MPU_OPPNITRO_UV_OC1350  1390000
#define OMAP4460_VDD_MPU_OPPNITRO_UV_OC1400  1395000
#define OMAP4460_VDD_MPU_OPPNITRO_UV_OC1500  1400000
#define OMAP4460_VDD_MPU_OPPNITRO_UV_OC1600  1410000
#define OMAP4460_VDD_MPU_OPPNITRO_UV_OC1650  1425000
#define OMAP4460_VDD_MPU_OPPNITRO_UV_OC1700  1440000
#define OMAP4460_VDD_MPU_OPPNITRO_UV_OC1750  1450000
...
struct omap_volt_data omap446x_vdd_mpu_volt_data[] = {
    ...
    VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPP75_UV, 15000, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0, 0, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
...
#ifdef CONFIG_OMAP_OCFREQS
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNITRO_UV_OC1350, 0, 0, 2200, 2000, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
    VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNITRO_UV_OC1400, 0, 0, 2245, 2062, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
    VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNITRO_UV_OC1500, 0, 0, 2348, 2160, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
    VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNITRO_UV_OC1600, 0, 0, 2484, 2276, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
    VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNITRO_UV_OC1650, 0, 0, 2522, 2328, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
    VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNITRO_UV_OC1700, 0, 0, 2594, 2376, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
    VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNITRO_UV_OC1750, 0, 0, 2651, 2424, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
...
static struct omap_vdd_dep_volt omap446x_vdd_mpu_core_dep_data[] = {
	...
	{.main_vdd_volt = OMAP4460_VDD_MPU_OPPNITRO_UV_OC1500, .dep_vdd_volt = OMAP4460_VDD_CORE_OPP100_UV},
	{.main_vdd_volt = OMAP4460_VDD_MPU_OPPNITRO_UV_OC1600, .dep_vdd_volt = OMAP4460_VDD_CORE_OPP100_UV},
	{.main_vdd_volt = OMAP4460_VDD_MPU_OPPNITRO_UV_OC1650, .dep_vdd_volt = OMAP4460_VDD_CORE_OPP100_UV},
	{.main_vdd_volt = OMAP4460_VDD_MPU_OPPNITRO_UV_OC1700, .dep_vdd_volt = OMAP4460_VDD_CORE_OPP100_UV},
	{.main_vdd_volt = OMAP4460_VDD_MPU_OPPNITRO_UV_OC1750, .dep_vdd_volt = OMAP4460_VDD_CORE_OPP100_UV},
...
static struct omap_opp_def __initdata omap446x_opp_def_list[] = {
#ifdef CONFIG_OMAP_UCFREQS
    /* MPU OPP1 - OPP25 */
   OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", true, 190000000, OMAP4460_VDD_MPU_OPP15_UV),
   ...
   /* MPU OPPX - OPP75 */
    ...
    OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", false, 1500000000, OMAP4460_VDD_MPU_OPPNITRO_UV_OC1500),
    OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", false, 1600000000, OMAP4460_VDD_MPU_OPPNITRO_UV_OC1600),
    OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", false, 1650000000, OMAP4460_VDD_MPU_OPPNITRO_UV_OC1650),
    OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", false, 1720000000, OMAP4460_VDD_MPU_OPPNITRO_UV_OC1700),
    OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", false, 1760000000, OMAP4460_VDD_MPU_OPPNITRO_UV_OC1750),
